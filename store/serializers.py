...
class AddressSerializer(serializers.ModelSerializer):
    class Meta:
        model = Address
        fields = ['id', 'billboxcode', 'address1', 'address2', 'address3',
              'country', 'state', 'city', 'zipcode', 'postalcode', 'lat', 'lng', 'phone', 'customer_id']

class BillboxSerializer(serializers.ModelSerializer):
    class Meta:
        model = Address
        fields = ['id', 'billboxcode', 'address1', 'address2', 'address3',
              'country', 'state', 'city', 'zipcode', 'postalcode', 'lat', 'lng', 'phone', 'customer_id']
...
class CreateAddressSerializer(serializers.Serializer):
    billboxcode = serializers.CharField()
